...
```bash
git clone https://github.com/y-abs/codex-brain-bootstrap.git /tmp/brain
...
```bash
git clone https://github.com/y-abs/codex-brain-bootstrap.git
...
_Generated by ᗺB Brain Bootstrap · [github.com/y-abs/codex-brain-bootstrap](https://github.com/y-abs/codex-brain-bootstrap)_
