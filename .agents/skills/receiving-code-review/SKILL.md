...
description: Use when receiving code review feedback — before implementing suggestions, especially if feedback seems unclear or technically questionable. Verify before implementing.
---
