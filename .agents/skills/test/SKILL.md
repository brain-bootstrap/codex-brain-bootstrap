---
name: test
description: Run the test suite and report results. Use after making changes to verify nothing is broken. Reads the test command from brain/build.md.
---
...
Read `brain/build.md` for the test command and any special flags.
