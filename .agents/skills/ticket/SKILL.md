---
name: ticket
description: Create a ticket/issue description with evidence-backed proof sections. Reads brain/templates.md for the template format. Saves to brain/tasks/ticket-<slug>.md.
---
...
Read `brain/templates.md` for the ticket template format.
...
### 5. Save and Report
Save to `brain/tasks/ticket-<slug>.md` where `<slug>` is a kebab-case summary.
