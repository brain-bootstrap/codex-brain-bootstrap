---
name: mr
description: Generate a PR/MR description after the review passes. Use after $review confirms the code is ready to merge. Reads brain/templates.md for the required format.
---
...
Read `brain/templates.md` — the required PR/MR format for this project.
...
Use the template from `brain/templates.md`. If no template exists, use this default:
