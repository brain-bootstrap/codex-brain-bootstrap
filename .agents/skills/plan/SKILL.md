---
name: plan
description: Plan a non-trivial task before implementing. Use when the task requires 3+ steps, multiple files, or an architectural decision. Writes a checkable plan to brain/tasks/todo.md.
---
...
- `brain/tasks/todo.md` — current task state (are we resuming?)
- `brain/tasks/lessons.md` — relevant past lessons
- `brain/architecture.md` — project structure
...
### 3. Write the plan to brain/tasks/todo.md
...
**Loaded docs:** <which brain/*.md files you read>
