...
- **NEVER delete** `brain/tasks/lessons.md` (accumulated wisdom)
- **NEVER delete** `brain/tasks/CODEX_ERRORS.md` (bug history)
- `brain/tasks/todo.md` can be archived if no active task
- `brain/tasks/mr-description-*.md` can be deleted after MR is merged
- `brain/tasks/ticket-*.md` can be deleted after ticket is created
